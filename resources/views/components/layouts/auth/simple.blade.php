...
<body class="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-gray-100 antialiased relative overflow-hidden dark:text-gray-100">
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-md border-b border-white/20 shadow-lg px-6 py-3 flex items-center space-x-4">
        ...
        <!-- Kamu bisa tambahkan menu lain di sini -->
    </nav>
